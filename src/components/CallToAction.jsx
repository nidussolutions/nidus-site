  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground px-4 sm:px-0">
          Pronto para Transformar seu Negócio?
        </h2>
        
        <p className='text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed px-4 sm:px-0'>
