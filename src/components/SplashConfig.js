...
export const SPLASH_CONFIG = {
  // Opções: 'default', 'minimal', 'glitch', 'cinematic', 'particles', 'welcome', 'darkGlitch'
  variant: 'darkGlitch',
...
export const getSplashComponent = () => {
  ...
  if (!Component) {
    console.warn(
      `Splash variant "${SPLASH_CONFIG.variant}" not found. Using default.`
    );
